...
export const homepageCopy: HomePageCopy = {
	...
	recordingModes: {
		title: "Professional recording and editing",
		subtitle:
			"Studio Mode prioritizes quality with local recording and full editing capabilities. Edit your recordings before sharing.",
		modes: [
			{
				name: "Studio Mode",
				description:
