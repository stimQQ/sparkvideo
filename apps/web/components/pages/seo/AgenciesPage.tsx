...
const agenciesContent: SeoPageContent = {
	...
	features: [
		...
		},
		{
			...
			description:
				"Use your own S3 storage for complete data ownership. Maintain compliance with your agency's privacy requirements.",
		},
		{
	...
	recordingModes: {
		title: "Professional Recording for Agency Workflows",
		description:
		...
		modes: [
			{
				...
				title: "Studio Mode for Professional Content",
				description:
					"Perfect for client presentations, project proposals, and onboarding. Create professional-quality recordings with separate screen and webcam capture, custom backgrounds, and precision editing tools. Share with a link or export locally.",
			},
		],
	},
	video: {
	...
	faqs: [
		...
		},
		{
			...
			answer:
				"Yes. Cap is open-source and privacy-first. You can connect your own S3 storage for complete data ownership and control over client data.",
		},
		{
			question: "How does Cap pricing work for agency teams?",
			answer:
				"Cap Pro is $8.16/month per user (billed annually) and includes unlimited cloud storage and all collaboration features. Volume discounts are available for teams over 10 users.",
		},
	],
	...
	comparisonTable: {
		...
		rows: [
			...
			[
				"Brand Control",
				{ text: "Own storage", status: "positive" },
	...
	migrationGuide: {
		...
		steps: [
			...
			"Set up Cap Pro for professional video sharing",
