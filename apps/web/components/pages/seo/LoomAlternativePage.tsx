...
export const loomAlternativeContent: SeoPageContent = {
	...
	recordingModes: {
		title: "Professional Recording with Cap",
		description:
			"Cap gives you professional-quality recordings with flexible sharing options",
		modes: [
			{
				icon: (
					<Clapperboard
				...
				title: "Studio Mode",
				description:
					"Professional recording at up to 4K quality. Captures both your screen and webcam separately so you can edit them later. Share with instant links or export locally. Includes built-in thread commenting for easy collaboration.",
			},
		],
	},
	...
	migrationGuide: {
		...
		steps: [
			...
			"Start recording with Studio Mode",
			"Share your recordings easily with Cap's built-in sharing features or export locally",
