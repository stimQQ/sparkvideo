...
const onlineClassroomToolsContent: SeoPageContent = {
	title: "Online Classroom Tools: Empower Remote Teaching with SparkVideo",
	description:
	...
	recordingModes: {
		title: "Professional Recording for Educational Content",
		description:
		...
		modes: [
			{
				...
				title: "Studio Mode for Lessons & Explanations",
				description:
					"Perfect for comprehensive lectures, concept explanations, and student feedback. Record high-quality videos with separate screen and webcam capture. Share with instant links or export locally. Built-in commenting enables follow-up questions.",
			},
		],
	},
...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		url: "https://sparkvideo.cc/solutions/online-classroom-tools",
		siteName: "SparkVideo",
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "SparkVideo: Online Classroom Tools",
			},
		],
		locale: "en_US",
		type: "website",
