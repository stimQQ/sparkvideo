...
const dailyStandupSoftwareContent: SeoPageContent = {
	title: "Daily Standup Software: Streamline Your Agile Meetings with SparkVideo",
	description:
	...
	recordingModes: {
		title: "Professional Recording for Efficient Standups",
		description:
		...
		modes: [
			{
				...
				title: "Studio Mode for Daily Updates",
				description:
					"Perfect for daily standups and sprint reviews. Create professional-quality standup videos with separate screen and webcam capture to demonstrate completed work or complex blockers. Share with instant links or export locally.",
			},
		],
	},
	...
	faqs: [
		...
		},
		{
			...
			answer:
				"We recommend keeping recordings under 3 minutes per person, focusing on the classic standup format: what was accomplished, what's planned for today, and any blockers. Cap's Studio Mode is perfectly optimized for these updates with professional quality and flexibility for complex situations.",
		},
		{
...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		description:
			"Looking for daily standup software? Discover how Cap helps remote or hybrid teams run async standups efficiently—no more timezone conflicts!",
		url: "https://sparkvideo.cc/solutions/daily-standup-software",
		siteName: "SparkVideo",
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "SparkVideo: Daily Standup Software",
			},
		],
		locale: "en_US",
		type: "website",
