...
export const metadata: Metadata = {
	title: "Employee Onboarding Platform: Streamline New-Hire Training with SparkVideo",
	description:
	...
	openGraph: {
		title:
			"Employee Onboarding Platform: Streamline New-Hire Training with SparkVideo",
		description:
			"Looking for a powerful employee onboarding platform? Discover how Cap's open-source screen recorder and asynchronous features simplify new-hire training.",
		url: "https://sparkvideo.cc/solutions/employee-onboarding-platform",
		siteName: "SparkVideo",
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "SparkVideo: Employee Onboarding Platform",
			},
		],
		locale: "en_US",
		type: "website",
...
const content: SeoPageContent = {
	...
	recordingModes: {
		title: "Professional Recording for Onboarding",
		description:
		...
		modes: [
			{
				...
				title: "Studio Mode for Onboarding Content",
				description:
					"Perfect for comprehensive training materials, system walkthroughs, and company overviews. Create professional-quality onboarding videos with separate screen and webcam capture. Share with instant links or export locally.",
			},
		],
	},
