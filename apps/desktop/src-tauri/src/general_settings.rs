...
pub struct GeneralSettingsStore {
    ...
    // Skip permission check if user confirmed in setup UI
    #[serde(default)]
    pub permissions_granted_override: bool,
    #[serde(default)]
    pub theme: AppTheme,
    #[serde(default)]
...
impl Default for GeneralSettingsStore {
    fn default() -> Self {
        Self {
            ...
            permissions_granted_override: false,
