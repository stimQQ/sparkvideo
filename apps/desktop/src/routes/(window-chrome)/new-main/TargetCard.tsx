...
export default function TargetCard(props: TargetCardProps) {
	...
	return (
		<button
			...
			class={cx(
				"group flex flex-col overflow-hidden rounded-lg border bg-gray-3 text-left outline-none transition-colors duration-100 hover:bg-gray-4 focus-visible:ring-2 focus-visible:ring-blue-9 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-1",
				local.selected ? "border-blue-9" : "border-transparent",
