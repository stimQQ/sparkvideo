...
pub struct CursorConfiguration {
    ...
    pub use_svg: bool,
    #[serde(default)]
    pub click_effect: ClickEffectConfiguration,
}

#[derive(Type, Serialize, Deserialize, Clone, Debug)]
#[serde(rename_all = "camelCase")]
pub struct ClickEffectConfiguration {
    #[serde(default = "yes")]
    pub enabled: bool,
    #[serde(default = "ClickEffectConfiguration::default_color")]
    pub color: String,
    #[serde(default = "ClickEffectConfiguration::default_size")]
    pub size: f32,
    #[serde(default = "ClickEffectConfiguration::default_duration")]
    pub duration: f32,
    #[serde(default = "ClickEffectConfiguration::default_opacity")]
    pub opacity: f32,
}

impl Default for ClickEffectConfiguration {
    fn default() -> Self {
        Self {
            enabled: true,
...
impl Default for CursorConfiguration {
    fn default() -> Self {
        Self {
            ...
            motion_blur: 0.5,
            use_svg: true,
            click_effect: ClickEffectConfiguration::default(),
        }
    }
}
